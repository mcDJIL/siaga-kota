...
export function ProfileAvatarCard({ profile, avatar, onAvatarChange, isLoading = false }) {
  ...
  return (
    ...
    >
      <ProfileImageUploader value={previewUrl} onChange={onAvatarChange} isLoading={isLoading} />
