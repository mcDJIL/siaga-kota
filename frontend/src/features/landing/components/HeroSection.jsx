...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-navy via-navy to-brand-green-dark px-4 py-20 sm:px-8 sm:py-28 lg:py-36">
      <div className="absolute inset-0 bg-navy/40" aria-hidden="true" />
      <div className="relative mx-auto flex w-full max-w-[1440px] flex-col items-start gap-6">
        <h1 className="font-heading text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-[56px] lg:leading-[1.1]">
